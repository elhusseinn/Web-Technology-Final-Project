# Generated by Django 3.1 on 2021-07-09 17:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('returnDate', models.DateField(default=book.models.tenDays)),
                ('bookedBook', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='book.book')),
